	...
	<view class="release">
		...
		<view class="repair-border" style="margin-bottom: 0;">
			<view class="repair-item r5">
				...
				<view class="repair-input">
					<input class="uni-input" name="roomNum" placeholder="详细地址,如:1号楼1单元101" :value="data.censusRegister" disabled=""/>
		...
		<view class="repair-border" style="margin-top: 0; border-top: 1px solid #EAE9E9;">
			<view class="repair-item ">
				...
				<view class="repair-input ">
					<input class="uni-input" name="roomNum" placeholder="详细地址,如:1号楼1单元101" :value="data.detailAddress" disabled=""/>					
				</view>
			</view>
		</view>
		<view class="repair-border ">
		...
		<view class="repair-border">
			...
			<view class="repair-item r7" >
				<view class="repair-input" style="margin-left: 100rpx">
					<textarea class="uni-input"  placeholder="记录走访村民情况" :value="data.problemDesc" disabled="" style="float: right; width: 100%;"/>
				</view>
			</view>
		</view>
		<view class="repair-border">
		...
		onLoad(options) {
			...
			getApply(data).then((res) => {
				if (res.code == "200") {
					...
					_this.imgArr = res.data.pictureUrl.split(",");
